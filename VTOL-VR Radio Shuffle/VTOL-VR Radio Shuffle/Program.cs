                    ...
                    case 4:
                        {
                            ...
                            string vtolVrPath = "";
                            Console.ForegroundColor = ConsoleColor.Yellow;
                            Console.WriteLine("The next process will create a .bat file. In order to automate the shuffle, you'll need to add a side game in your steam and link it to the .bat file.\n\n Continue?");
                            Console.ResetColor();
